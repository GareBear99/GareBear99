...
- ⚛️ [ARC-Neuron](https://github.com/GareBear99/ARC-Neuron-LLMBuilder) — LLMBuilder, measure, promote the better ones through regression-aware gate, every decision restorable 
...
- 🧑‍🦯 [Voxel_Audio](https://github.com/GareBear99/Voxel_Audio) — Free custom RGB Audio Visualizer Software
