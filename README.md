...
- ⚛️ [ARC-Neuron](https://github.com/GareBear99/ARC-Neuron-LLMBuilder) — train LLM, measure them, promote the better ones through a regression-aware gate, every decision restorable
