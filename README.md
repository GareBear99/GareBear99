...
- 🗣️ [arc-language-module](https://github.com/GareBear99/arc-language-module) — A text-first multilingual language/script/lineage substrate for ARC-style systems & AI
